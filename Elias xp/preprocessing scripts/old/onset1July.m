...
%block1
names = {'gameP_choice','gameL_choice','gameT_choice','gameP_fb_positive','gameP_fb_negative','gameL_fb_positive','gameL_fb_negative','gameT_fb_positive','gameT_fb_negative','game_fb_slow','sel','base_sel','Instructions'};
...
if isempty(fb_slow1)
    ...
    onsets = {gameP_disp1,gameL_disp1,gameT_disp1,gameP_fbp1,gameP_fbn1,gameL_fbp1,gameL_fbn1,gameT_fbp1,gameT_fbn1,sel1,base1,trash1'};
    durations = {dur_gameP_disp1,dur_gameL_disp1,dur_gameT_disp1,dur_gameP_fbp1,dur_gameP_fbn1,dur_gameL_fbp1,dur_gameL_fbn1,dur_gameT_fbp1,dur_gameT_fbn1,dur_sel1,dur_base1,dur_Instr};
end

pmod = pmod1;
save([int2str(subnum) '_block1'],'names','onsets','durations','pmod')
...
if isempty(fb_slow2)
    names = {'gameP_choice','gameL_choice','gameT_choice','gameP_fb_positive','gameP_fb_negative','gameL_fb_positive','gameL_fb_negative','gameT_fb_positive','gameT_fb_negative','sel','base_sel','Instructions'};
    onsets = {gameP_disp2,gameL_disp2,gameT_disp2,gameP_fbp2,gameP_fbn2,gameL_fbp2,gameL_fbn2,gameT_fbp2,gameT_fbn2,sel2,base2,trash2'};
    durations = {dur_gameP_disp2,dur_gameL_disp2,dur_gameT_disp2,dur_gameP_fbp2,dur_gameP_fbn2,dur_gameL_fbp2,dur_gameL_fbn2,dur_gameT_fbp2,dur_gameT_fbn2,dur_sel2,dur_base2,dur_Instr};
end

pmod = pmod2;
save([int2str(subnum) '_block2'],'names','onsets','durations','pmod')
...
if isempty(fb_slow3)
    names = {'gameP_choice','gameL_choice','gameT_choice','gameP_fb_positive','gameP_fb_negative','gameL_fb_positive','gameL_fb_negative','gameT_fb_positive','gameT_fb_negative','sel','base_sel','Instructions'};
    onsets = {gameP_disp3,gameL_disp3,gameT_disp3,gameP_fbp3,gameP_fbn3,gameL_fbp3,gameL_fbn3,gameT_fbp3,gameT_fbn3,sel3,base3,trash3'};
    durations = {dur_gameP_disp3,dur_gameL_disp3,dur_gameT_disp3,dur_gameP_fbp3,dur_gameP_fbn3,dur_gameL_fbp3,dur_gameL_fbn3,dur_gameT_fbp3,dur_gameT_fbn3,dur_sel3,dur_base3,dur_Instr};
end

pmod = pmod3;
save([int2str(subnum) '_block3'],'names','onsets','durations','pmod')
disp('COMPLETE')