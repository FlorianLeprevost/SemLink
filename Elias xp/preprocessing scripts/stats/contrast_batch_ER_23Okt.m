...
if contrasts
    ...
    %Contrast Con v Icon Choice+PMOD
    %matlabbatch{1}.spm.stats.con.consess{26}.tcon.name = 'ConIcon_Choice+PMOD';
    %matlabbatch{1}.spm.stats.con.consess{26}.tcon.weights = [1 1 -1 -1];                                                                        
    %atlabbatch{1}.spm.stats.con.consess{26}.tcon.sessrep = 'repl';
